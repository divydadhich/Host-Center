...
export default function Work() {
  ...
  return (
    <div className="max-w-[430px] mx-auto min-h-screen bg-indigo-100 relative">
        ...
        {workData.map((item, index) => (
          <div key={index} className="bg-white rounded-2xl p-4 shadow-sm">
            ...
            <button
              ...
              className="mt-4 w-full flex items-center justify-center gap-1 text-blue-500 text-sm font-medium"
            >
              See more details
              <span>⌃</span>
            </button>
